...
use App\Http\Controllers\AdminController;use App\Http\Controllers\AuthController;
...
Route::middleware('auth:sanctum')->post('logout', [AuthController::class, 'logout']);Route::get('test', function () {
